...
class_<CScriptGameObject> script_register_game_object1(class_<CScriptGameObject>&& instance)
{
    return std::move(instance)
        ...
        .def("play_cycle", (u32(CScriptGameObject::*)(LPCSTR) const)(&CScriptGameObject::play_cycle))
        .def("play_cycle", (u32(CScriptGameObject::*)(LPCSTR, bool) const)(&CScriptGameObject::play_cycle))
